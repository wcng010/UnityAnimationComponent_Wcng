...
public class CreateSkillTrackWindow : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        // Import UXML
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/GameScript/GameEditor/SkillEditor/CreateSkillTrackWindow.uxml");
    ...
    //模板地址
    public static string MultiLineTrackPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestMultiTrack.txt";

    public static string MultiLineTrackEventPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestMultiLineFrameEven.txt";
    public static string SingleLineTrackPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestSingLineTrack.txt";
    public static string SingleLineTrackEventPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestSinglineEvent.txt";
    public static string InspecterHelperPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestEventInspectorHelper.txt";
    public static string InspecterPath = "Assets/GameScript/GameEditor/SkillEditor/MobaTrack/TestEventInspector.txt";
