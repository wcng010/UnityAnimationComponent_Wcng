...
namespace GameScript.GameMain.Skill
{
    ...
    public class SimpleItemStyle : SkillTrackItemStyleBase
    {
        ...
        {
            TrackItemAssetPAth = TrackItemAssetPAth == null ? "Assets/GameScript/GameEditor/SkillEditor/AnimationTrackItem.uxml" : TrackItemAssetPAth;
    ...
    public class EventItemStyle : SimpleItemStyle
    {
        ...
        public override void Init(SkillTrackStyleBase ParentTrackStyle, float width, float position, string name, string TrackItemAssetPAth = null)
        {
            base.Init(ParentTrackStyle, width, position, name, "Assets/GameScript/GameEditor/SkillEditor/EvenItemStyle.uxml");
